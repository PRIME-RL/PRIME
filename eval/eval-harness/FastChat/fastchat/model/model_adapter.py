...
class UltraInteractAdapter(BaseModelAdapter):
    """The model adapter for ultrainteract"""

    def match(self, model_path: str):
        return "ultrainteract" in model_path.lower()

    def get_default_conv_template(self, model_path: str) -> Conversation:
        return get_conv_template("ultrainteract")

class CritiqueAdapter(BaseModelAdapter):
    """The model adapter for ultrainteract"""

    def match(self, model_path: str):
        return "critique" in model_path.lower()

    def get_default_conv_template(self, model_path: str) -> Conversation:
        return get_conv_template("critique")
...
register_model_adapter(UltraInteractAdapter)
